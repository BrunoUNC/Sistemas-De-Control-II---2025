%% Caso de estudio 3. Sistema no lineal de cuatro variables de estado con y sin observador 
...
Bo = C';
Qo = diag([10 1 10 1]);
Ro = diag([1 1]);  % <- Matriz R ahora es diagonal (dual al número de salidas)
Ko = lqr(Ao, Bo, Qo, Ro)';
...
title('Acción de control'); ylabel(''); xlabel('Tiempo [s]'); legend('Sin observador','Con observador');
